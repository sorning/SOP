# Prompting Direct audio-to-motion mapping for LTX-2 — Official Blog

> **来源**：https://ltx.io/model/model-blog/prompting-guide-for-ltx-2
> **备用 URL**：https://ltx.video/blog/how-to-prompt-for-ltx-2（GitHub README 推荐的 URL，但 web_fetch 返回 403）
> **作者**：LTX Team
> **发布日期**：February 17, 2026
> **抓取日期**：2026-05-18
> **正文一字不改照搬**——已去除网页导航/侧边栏/footer 等无关 UI 噪音，仅保留 prompting 指南正文 + 12 个官方示范 prompt

> **重要**：LTX-2.3 的 HuggingFace model card 也将本 blog 作为官方 prompting 指南，意味着本 blog 同样适用于 LTX-2.3。
...
### Example Prompt 1 — Monster Truck
...
### Example Prompt 2 — Dramatic Family Scene
...
### Example Prompt 3 — Baker (POV from Inside Oven)
...
### Example Prompt 4 — Talk Show Set
...
### Example Prompt 5 — Pinocchio Interrogation
...
### Example Prompt 6 — Alien Discovery
...
### Example Prompt 7 — Cinematic Run
...
### Example Prompt 9 — Acoustic Singer in Bar
...
### Example Prompt 10 — Robot Encounter
...
### Example Prompt 11 — Live News Oil Strike
...
- The above 11 example prompts are drawn from the blog's embedded video showcases. Each prompt corresponds to a Vimeo-hosted demo on the original blog page.
- Blog title text "Prompting Direct audio-to-motion mapping for LTX-2" is the SEO title; this is the same content as referenced from GitHub README as "https://ltx.video/blog/how-to-prompt-for-ltx-2".
